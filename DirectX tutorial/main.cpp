...
void SetFullscreen(bool fullscreen)
{
	if (g_Fullscreen != fullscreen)
	{
		...
		else
		{
			...
			::SetWindowPos(g_hWnd, HWND_NOTOPMOST, g_WindowRect.left, g_WindowRect.right, g_WindowRect.right - g_WindowRect.left, g_WindowRect.bottom - g_WindowRect.top, SWP_FRAMECHANGED | SWP_NOACTIVATE);
...
int CALLBACK wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR lpCmdLine, int nCmdShow)
{
	...
	g_hWnd = CreateWindow(windowClassName, hInstance, L"DirectX 12 Tutorial", g_ClientWidth, g_ClientHeight);
